...
public class UserService {
    ...
    public boolean deleteUser(String username, AuthenticationService authService) {
        if (!userPasswords.containsKey(username)) {
    ...
    public Map<String, String> getUserProfile(String username) {
        ...
        profile.put("orderCount", String.valueOf(orderService != null ? orderService.countUserOrders(username) : 0));
        profile.put("totalSpent", String.valueOf(orderService != null ? orderService.calculateUserSpending(username) : 0.0));
        return profile;
    }
    ...
    public boolean unblockUser(String username, AuthenticationService authService) {
        if (!userPasswords.containsKey(username)) return false;
        userBlocked.put(username, false);
