...
public class ConfigurationService {
    ...
    public void loadConfig(String configFile) {
        try (BufferedReader br = new BufferedReader(new FileReader(configFile))) {
            ...
            loggingService.log("INFO", "Config loaded from " + configFile);
        } catch (IOException e) { loggingService.log("ERROR", "Config load failed: " + e.getMessage()); }
    }
    ...
    private void applyConfigProperty(String key, String value) {
        switch (key) {
            ...
            case "log.file":
                logFilePath = value;
                loggingService.setLogFilePath(value);
                break;
            ...
            case "verbose.logging":
                verboseLogging = Boolean.parseBoolean(value);
                loggingService.setVerboseLogging(verboseLogging);
                break;
        }
    }
