...
public class AuthenticationService {
    ...
    public AuthenticationService(UserService userService, LoggingService loggingService, AuditService auditService,
                                 ConfigurationService configService, EmailService emailService) {
    ...
    public boolean authenticate(String username, String password) {
        ...
        String stored = userService.getStoredPassword(username);
    ...
    public boolean changePassword(String username, String oldPassword, String newPassword) {
        ...
        userService.setStoredPassword(username, hashPassword(newPassword));
